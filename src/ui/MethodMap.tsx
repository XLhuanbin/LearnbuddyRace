 ...
 */
export function MethodMap({ papers, methods, relations, onOpenEvidence, onOpenPair, onCompareExperiments, showPending, showUnclear }: Props) {
  ...
  const visibleRelations = useMemo(
    ...
    [relations, showPending, showUnclear],
  );
